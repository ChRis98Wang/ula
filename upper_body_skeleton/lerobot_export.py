...
def episode_schema():
    return pa.schema(
        [
            ...
            pa.field("communicative_intent", pa.string()),
            pa.field("observed_affect", pa.string()),
            pa.field("gesture_function", pa.string()),
            pa.field("emotion_trajectory", pa.string()),
            pa.field("motion_style", pa.string()),
            pa.field("intensity", pa.string()),
            pa.field("speed", pa.string()),
            pa.field("openness", pa.string()),
            pa.field("tension", pa.string()),
...
def flatten_episode_record(record, episode_index, task_index, length):
    ...
    return {
        ...
        "communicative_intent": labels.get("communicative_intent", labels.get("intent", "")),
        "observed_affect": labels.get("observed_affect", ""),
        "gesture_function": labels.get("gesture_function", ""),
        "emotion_trajectory": labels.get("emotion_trajectory", ""),
        "motion_style": labels.get("motion_style", ""),
        "intensity": labels.get("intensity", ""),
        "speed": labels.get("speed", ""),
        "openness": labels.get("openness", ""),
        "tension": labels.get("tension", ""),
        "duration_sec": optional_float(labels.get("duration_sec")),
